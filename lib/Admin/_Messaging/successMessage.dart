...
class AdminSuccessMessage extends StatefulWidget {
  const AdminSuccessMessage({ key }) : super(key: key);

  @override
  _AdminSuccessMessageState createState() => _AdminSuccessMessageState();
}

class _AdminSuccessMessageState extends State<AdminSuccessMessage> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          SubTitle(
            subTitleText: 'Your message was sent successfully',
          ),
          DefaultButton(
            btnText: 'Ok',
            onPressed: () {
