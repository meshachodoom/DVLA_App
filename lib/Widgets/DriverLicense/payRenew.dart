...
class PayRenewLicense extends StatefulWidget {
  final String docid;

  const PayRenewLicense({ key, this.docid }) : super(key: key);
  @override
  _PayRenewLicenseState createState() => _PayRenewLicenseState(docid);
}

class _PayRenewLicenseState extends State<PayRenewLicense> {
  String docids;
  _PayRenewLicenseState(this.docids);
